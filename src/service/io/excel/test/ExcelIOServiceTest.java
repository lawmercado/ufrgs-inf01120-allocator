...
import service.io.excel.ExcelIOService;

public class ExcelIOServiceTest {

	private final String INPUT_VALID_TEST_FILE_PATH = "src/service/io/excel/test/testSheet.xlsx"; 
