package allocator.algorithm.impl.test;
...
public class OurAllocateAlgorithmTest {
	...
	{
		Discipline discipline = new Discipline("INF01120", "T�cnicas de Constru��o de Programas");
		Group group = new Group(discipline, "A", "�RIKA COTA", 80);
	...
	@Test
	public void testAlocate3() //CLASSROOMPLACES = LESSONPLACES, POR�M RESOURCES N�O FECHAM
	{						   //SEMPRE DA ERRADO
		Discipline discipline = new Discipline("INF01120", "T�cnicas de Constru��o de Programas");
		Group group = new Group(discipline, "A", "�RIKA COTA", 80);
	...
	@Test
	public void testAlocate4() //CLASSROOMPLACES = LESSONPLACES POR�M N�O H� NENHUM RESOURCE
	{						   //SEMPRE DA ERRADO
		Discipline discipline = new Discipline("INF01120", "T�cnicas de Constru��o de Programas");
		Group group = new Group(discipline, "A", "�RIKA COTA", 80);
	...
	@Test
	public void testAlocate5() //CLASSROOMPLACES N�O FECHA COM LESSONPLACES POR�M RESOURCE FECHA
	{						   //SEMPRE DA ERRADO
		Discipline discipline = new Discipline("INF01120", "T�cnicas de Constru��o de Programas");
		Group group = new Group(discipline, "A", "�RIKA COTA", 80);
